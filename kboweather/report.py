...
def flight_svg(r: dict) -> str:
    ...
    lab = (f'<div class="lab"><b>{signed(delta)}</b>'
           ...
           f'<span class="note">기준 타구 161 km/h · 30° · 백스핀 1800 rpm<br>'
...
def to_html(day: dict) -> str:
    ...
    parts.append(
        ...
        +         '<b>비거리 지수</b>는 100 mph·30°·1800 rpm 표준 타구를 오늘 공기밀도와 구장 외야 방향의 바람으로 시뮬레이션해 표준 대기(20 ℃·1013 hPa·50 %·무풍, 125.1 m)와 비교한 값이며, '
